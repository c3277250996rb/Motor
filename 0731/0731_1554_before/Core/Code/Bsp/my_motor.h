...
#define MOTOR_PWM_UPDATE_CHECK()   (g_motor_data.motor_pwm = labs(g_motor_data.motor_pwm) > MOTOR_PWM_LIMIT ? SIGN(g_motor_data.motor_pwm) * MOTOR_PWM_LIMIT : g_motor_data.motor_pwm)
/*  BDC基础驱动  zat*/
#if 1
/*************************************    基本驱动    *****************************************************/
